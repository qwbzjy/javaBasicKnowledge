...
public class GenericInterfaceExample {
    ...
    public static void main(String[] args) {
        ...
        MinMaxImpl<String> stringMinMax = new MinMaxImpl<String>(strOfArray);

        System.out.println("Max value in intOfArray: "+intMinMax.max());
        System.out.println("Min value in intOfArray: "+intMinMax.min());
        System.out.println("Max value in charOfArray: "+intMinMax.max());
        System.out.println("Min value in charOfArray: "+intMinMax.min());
        System.out.println("Max value in strOfArray: "+intMinMax.max());
        System.out.println("Min value in strOfArray: "+intMinMax.min());
